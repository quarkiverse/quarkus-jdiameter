...
Please submit a report in the the {this-issue.tracker.ur}, against the product `{provider} {product-name}`, or contact the authors.

When submitting a bug report, be sure to mention the manual's identifier: {provider} {product-name}
