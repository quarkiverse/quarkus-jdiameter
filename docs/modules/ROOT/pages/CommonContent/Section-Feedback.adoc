...
Please submit a report in the the {this-issue-tracker-url}, against the product '{product-name}`, or contact the authors.

When submitting a bug report, be sure to mention the manual's identifier: {product-name}
