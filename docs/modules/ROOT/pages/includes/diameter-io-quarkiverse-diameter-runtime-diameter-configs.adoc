...
a|icon:lock[title=Fixed at build time] [[diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-parameter-caching-name]]`link:#diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-parameter-caching-name[diameter.parameter.caching-name]`

`link:#diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-parameter-caching-name[diameter."named-config".parameter.caching-name]`
...
h|[[diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-network-realms-agent-the-agent-configuration]]link:#diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-network-realms-agent-the-agent-configuration[The Agent configuration]
This configuration section is optional
h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-network-realms-agent-properties]]`link:#diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-network-realms-agent-properties[diameter.network.realms.agent."properties"]`

`link:#diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-network-realms-agent-properties[diameter.network.realms."realms".agent."properties"]`

`link:#diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-network-realms-agent-properties[diameter."named-config".network.realms."realms".agent."properties"]`

`link:#diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-network-realms-agent-properties[diameter."named-config".network.realms.agent."properties"]`
