...
h|[[diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-extension-the-extensions-elements-contains-elements-that-override-existing-components-in-the-diameter-stack]]link:#diameter-io-quarkiverse-diameter-runtime-diameter-configs_diameter-extension-the-extensions-elements-contains-elements-that-override-existing-components-in-the-diameter-stack[The extensions elements contains elements that override existing components in the Diameter stack]
This configuration section is optional
h|Type
h|Default
