...
<2> The configuration option to apply to the diameter service
...
=== Diameter Detail Config

=== Local Peers

include::../includes/config-group-io-go-diameter-runtime-config-local-peer.adoc[leveloffset=+1]

=== Network

include::../includes/config-group-io-go-diameter-runtime-config-network.adoc[leveloffset=+1]

=== Peers

include::../includes/config-group-io-go-diameter-runtime-config-peer.adoc[leveloffset=+1]

=== Realms

include::../includes/config-group-io-go-diameter-runtime-config-realm.adoc[leveloffset=+1]

=== Parameters

include::../includes/config-group-io-go-diameter-runtime-config-parameter.adoc[leveloffset=+1]

=== Extensions

include::../includes/config-group-io-go-diameter-runtime-config-extension.adoc[leveloffset=+1]
