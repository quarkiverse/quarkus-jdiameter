...
{provider} Diameter Stack does not have any hardware requirements.

[[_jdiameter_software_prerequisites]]
=== Software Prerequisites

{provider} Diameter Stack has the following software dependencies:
* slf4j

[[_jdiameter_source_code]]
== Source Code

This section provides instructions on how to obtain and build the {provider} Diameter Stack from source code.
