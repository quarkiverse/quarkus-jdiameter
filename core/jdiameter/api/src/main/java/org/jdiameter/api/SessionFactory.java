...
public interface SessionFactory {
    ...
    <T extends AppSession> T getNewAppSession(ApplicationId applicationId, Class<? extends AppSession> userSession)
    ...
    <T extends AppSession> T getNewAppSession(String sessionId, ApplicationId applicationId,
