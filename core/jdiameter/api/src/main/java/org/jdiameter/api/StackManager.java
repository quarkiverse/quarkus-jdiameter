...
/**
 * <P>
 * The basic service for managing a set of Diameter stacks.<br>
 *
 * <P>
 ...
 *
 * <P>
 * When the method <code>getSession</code> is called,
 * the <code>StackManager</code> will attempt to locate a suitable stack from amongst those loaded at initialization and
...
public final class StackManager {
     ...
     * <p>
     * The <code>getLogWriter</code> and <code>setLogWriter</code> methods should be used instead of the
     * <code>get/setlogStream</code> methods, which are deprecated.
     *
    ...
    /**
     * Sets the logging/tracing <code>PrintWriter</code> object that is used by the <code>StackManager</code> and all
     * drivers.
     * <p>
     * There is a minor versioning problem created by the introduction of the method <code>setLogWriter</code>. The
     * method <code>setLogWriter</code> cannot create a <code>PrintStream</code> object that will be returned by
     * <code>getLogStream</code>
     *
    ...
    /**
     * Attempts to locate a stack. The <code>StackManager</code> attempts to select an appropriate stack from the set of
    ...
    /**
     * Registers the given stack with the <code>ScoketManager</code>. A newly-loaded stack class should call the method
     * <code>registerStack</code> to make itself known to the <code>StackManager</code>.
     *
    ...
    /**
     * Drops a driver from the <code>DiameterManager</code>'s list. Applets can only deregister stacks from their own
     * classloaders.
     *
     ...
     *
     * <P>
     * <B>Note:</B> The classname of a stack can be found using
