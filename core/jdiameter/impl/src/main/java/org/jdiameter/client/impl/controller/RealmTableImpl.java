...
public class RealmTableImpl implements IRealmTable {
    ...
    @Override
    public Realm addRealm(String realmName, ApplicationId applicationId, LocalAction action, IAgentConfiguration agentConf,
            boolean dynamic, long expirationTime,
            String[] hosts) throws InternalException {
        IAgent agent = null;
        switch (action) {
     ...
     * (non-Javadoc)
     *
     * @see org.jdiameter.client.api.controller.IRealmTable#removeRealmApplicationId(java.lang.String,
