...
public class XMLConfiguration extends EmptyConfiguration {
    ...
    protected void addStatisticLogger(org.jdiameter.client.impl.helpers.Parameters name, Node node) {
        ...
        add(name,
                getInstance().add(StatisticsLoggerPause, Long.parseLong(pause))
                        .add(StatisticsLoggerDelay, Long.parseLong(delay)).add(StatisticsEnabled, Boolean.parseBoolean(enabled))
    ...
    private Configuration addOverloadMonitorItem(Node node) {
        return getInstance().add(OverloadEntryIndex, Integer.valueOf(getAttrValue(node, "index")))
    ...
    protected Configuration addRealm(Node node) {
        ...
        realmEntry.add(ApplicationId, new Configuration[] { addApplicationID(node.getChildNodes()) })
    ...
    protected void addInternalExtension(Ordinal ep, String value) {
        ...
        AppConfiguration internalExtensions = (AppConfiguration) extensionConfs[org.jdiameter.client.impl.helpers.ExtensionPoint.Internal
                .id()];
