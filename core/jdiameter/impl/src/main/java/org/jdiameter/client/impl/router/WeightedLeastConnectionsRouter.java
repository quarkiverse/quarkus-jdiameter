 ...
 * @see <a
 * 		href="http://kb.linuxvirtualserver.org/wiki/Weighted_Least-Connection_Scheduling">http://kb.linuxvirtualserver.org/wiki/Weighted_Least-Connection_Scheduling</a>
 */
...
public class WeightedLeastConnectionsRouter extends RouterImpl implements IRouter
{
	...
	/**
	 * Return peer with least connections<br/> {@url http://kb.linuxvirtualserver.org/wiki/Weighted_Least-Connection_Scheduling
