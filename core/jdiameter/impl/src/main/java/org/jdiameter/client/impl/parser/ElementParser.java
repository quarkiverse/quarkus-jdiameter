...
public class ElementParser implements IElementParser {
    ...
    /**
     * This is seconds shift (70 years in seconds) applied to date, since NTP date starts since 1900, not 1970.
     */
    ...
    public AvpSetImpl decodeAvpSet(byte[] buffer) {
        try {
