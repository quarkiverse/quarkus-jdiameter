...
public class ServerGxSessionImpl extends AppGxSessionImpl
        implements ServerGxSession, NetworkReqListener, EventListener<Request, Answer> {
    ...
    public ServerGxSessionImpl(IServerGxSessionData sessionData, IGxMessageFactory fct, ISessionFactory sf,
    ...
    @Override
    public void sendCreditControlAnswer(GxCreditControlAnswer answer)
            throws InternalException, IllegalDiameterStateException, RouteException, OverloadException {
        handleEvent(new Event(false, null, answer));
    }

    @Override
    public void sendGxReAuthRequest(GxReAuthRequest request)
            throws InternalException, IllegalDiameterStateException, RouteException, OverloadException {
            ...
            switch (state) {
                case IDLE:
                    switch (eventType) {
                        ...
                        case SENT_INITIAL_RESPONSE:
                            ...
                            break;
                        default:
                            throw new InternalException("Wrong state: " + ServerGxSessionState.IDLE + " one event: " + eventType
                ...
                case OPEN:
                    switch (eventType) {
                        ...
                        case RECEIVED_RAA:
                            listener.doGxReAuthAnswer(this, (GxReAuthRequest) localEvent.getRequest(),
                                    (GxReAuthAnswer) localEvent.getAnswer());
                            break;
                        case SENT_RAR:
            ...
            try {
                ...
                switch (request.getCommandCode()) {
                    case GxReAuthRequest.code:
                        handleEvent(new Event(Event.Type.RECEIVED_RAA, factory.createGxReAuthRequest(request),
                                factory.createGxReAuthAnswer(answer)));
                        break;
                    default:
