...
public class SessionFactoryImpl implements ISessionFactory {
    ...
    public <T extends AppSession> T getNewAppSession(ApplicationId applicationId, Class<? extends AppSession> aClass)
    ...
    @Override
    @SuppressWarnings("unchecked")
    public <T extends AppSession> T getNewAppSession(String sessionId, ApplicationId applicationId,
