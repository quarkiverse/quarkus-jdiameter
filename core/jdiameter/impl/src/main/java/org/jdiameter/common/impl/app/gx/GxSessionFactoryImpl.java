...
public class GxSessionFactoryImpl
        implements IGxSessionFactory, ClientGxSessionListener, ServerGxSessionListener, StateChangeListener<AppSession>,
    ...
    public GxSessionFactoryImpl(SessionFactory sessionFactory, int defaultDirectDebitingFailureHandling,
    ...
    public AppSession getSession(String sessionId, Class<? extends AppSession> aClass) {
        ...
        try {
            if (aClass == ClientGxSession.class) {
                IClientGxSessionData sessionData = (IClientGxSessionData) this.sessionDataFactory
                        .getAppSessionData(ClientGxSession.class, sessionId);
                ClientGxSessionImpl clientSession = new ClientGxSessionImpl(sessionData, this.getMessageFactory(),
                ...
                IServerGxSessionData sessionData = (IServerGxSessionData) this.sessionDataFactory
                        .getAppSessionData(ServerGxSession.class, sessionId);
                ServerGxSessionImpl serverSession = new ServerGxSessionImpl(sessionData, this.getMessageFactory(),
                ...
                throw new IllegalArgumentException("Wrong session class: " + aClass + ". Supported[" + ClientGxSession.class
                        + "," + ServerGxSession.class + "]");
            }
        } catch (Exception e) {
    ...
    public void stateChanged(AppSession source, Enum oldState, Enum newState) {
        logger.info("Diameter Gx SessionFactory :: stateChanged :: source[{}], oldState[{}], newState[{}]",
