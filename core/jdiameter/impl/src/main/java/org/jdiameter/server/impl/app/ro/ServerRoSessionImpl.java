...
public class ServerRoSessionImpl extends AppRoSessionImpl
    ...
    public ServerRoSessionImpl(IServerRoSessionData sessionData, IRoMessageFactory fct, ISessionFactory sf,
            ...
            switch (state) {
                case IDLE:
                    switch (eventType) {
                        ...
                        default:
                            throw new InternalException("Wrong state: " + ServerRoSessionState.IDLE + " one event: " + eventType
