        ...
        public boolean sendMessage(IMessage message) throws TransportException, OverloadException {
            ...
            try {
                ...
                if (message.isRequest()) {
                        ...
                        if (answer != null) {
                            ...
                            if (avpSessionId != null) {
                                ...
                                if (sessionListener != null) {
                                    logger.debug(
                                            "Giving message to sessionListener to process as Session-Id AVP existed in message "
                    ...
                    if (answer != null) {
                        if (logger.isDebugEnabled()) {
                            logger.debug("Removing message with HbH Identifier [{}] from Peer Requests Map",
                    ...
                    if (logger.isDebugEnabled()) {
                        logger.debug(
                                "Message is an answer. Setting answer to the message and fetching message from Peer Requests Map using HbH Identifier [{}]",
                                message.getHopByHopIdentifier());
                    }
                    answer = message;
