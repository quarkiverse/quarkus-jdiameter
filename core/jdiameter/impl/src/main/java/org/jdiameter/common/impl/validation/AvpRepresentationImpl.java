 ...
 public class AvpRepresentationImpl implements AvpRepresentation
 {
	  ...
	  * children is always different than fully defined AVP representation. <br> This constructor should be generally
	 ...
	 { //this is used in RAs, cause ... AvpSet is asexual AVP, no code, no vendor
		 // let it rip
