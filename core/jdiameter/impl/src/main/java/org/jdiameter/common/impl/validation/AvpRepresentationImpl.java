...
public class AvpRepresentationImpl implements AvpRepresentation {
    ...
    /**
     * Constructor used to represent weak children. - weak means its only defined by name in some other AVP. After
     * configuration parse procedure is complete weak children are resolved. Weak children should not be stored in Set
     * or any other has structure, its due to nature of hashing, which is done on vendor and code, which for weak
     * children is always different than fully defined AVP representation. <br>
     * This constructor should be generally
     * used by extending classes, as well as no argument constructor.
     *
     * @param name
     * @param vendor
     */
    ...
    /**
     * This constructor is used my validator to lookup correct representation. Its hash and equals methods will match to
     * fully populated avp representation in any data structure
     *
     * @param code
     * @param vendor
     */
    ...
    public AvpRepresentationImpl(String name, String description, int code, boolean mayEncrypt, String ruleMandatory,
        ...
        for (AvpRepresentation childrenVAvp : getChildren()) {
            ...
            if (!childrenVAvp.isCountValidForMultiplicity(count)) {
                throw new AvpNotAllowedException(
                        "AVP: " + childrenVAvp + " has wrong count, in grouped parent avp - " + (count) + ", allowed: "
                                + childrenVAvp.getMultiplicityIndicator(),
                        getCode(), getVendorId());
            }
    ...
    public String toString() {
        ...
        sb.append("name: ").append(this.getName()).append(", code: ").append(this.getCode()).append(", vendor: ")
                .append(this.getVendorId()).append(", weak: ")
                .append(this.isWeak()).append(", grouped: ").append(this.isGrouped()).append(", type: ").append(this.getType())
                .append(", multiplicity: ")
