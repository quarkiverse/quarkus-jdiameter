...
public class S6aServerSessionImpl extends S6aSession
    ...
    public S6aServerSessionImpl(IServerS6aSessionData sessionData, IS6aMessageFactory fct, ISessionFactory sf,
                ...
                case IDLE:
                    switch (eventType) {
                        ...
                        case RECEIVE_AIR:
                            ...
                            setState(newState);
                            listener.doAuthenticationInformationRequestEvent(this,
                                    (JAuthenticationInformationRequest) event.getData());
                            break;
                ...
                case MESSAGE_SENT_RECEIVED:
                    switch (eventType) {
                        ...
                        case RECEIVE_CLA:
                            try {
                                super.cancelMsgTimer();
                                listener.doCancelLocationAnswerEvent(this, (JCancelLocationRequest) localEvent.getRequest(),
                                        (JCancelLocationAnswer) localEvent.getAnswer());
                            } finally {
                                newState = S6aSessionState.TERMINATED;
                                setState(newState);
                            }
                        ...
                        case RECEIVE_IDA:
                            try {
                                super.cancelMsgTimer();
                                listener.doInsertSubscriberDataAnswerEvent(this,
                                        (JInsertSubscriberDataRequest) localEvent.getRequest(),
                        ...
                        case RECEIVE_DSA:
                            try {
                                super.cancelMsgTimer();
                                listener.doDeleteSubscriberDataAnswerEvent(this,
                                        (JDeleteSubscriberDataRequest) localEvent.getRequest(),
                        ...
                        case RECEIVE_RSA:
                            try {
                                super.cancelMsgTimer();
                                listener.doResetAnswerEvent(this, (JResetRequest) localEvent.getRequest(),
                                        (JResetAnswer) localEvent.getAnswer());
                            } finally {
                                newState = S6aSessionState.TERMINATED;
                                setState(newState);
                            }
            ...
            try {
                switch (request.getCommandCode()) {
                    case JAuthenticationInformationRequest.code:
                        handleEvent(new Event(Event.Type.RECEIVE_AIR,
                                messageFactory.createAuthenticationInformationRequest(request), null));
                        break;
                    ...
                    case JUpdateLocationRequest.code:
                        handleEvent(
                                new Event(Event.Type.RECEIVE_ULR, messageFactory.createUpdateLocationRequest(request), null));
                        break;
            ...
            try {
                switch (answer.getCommandCode()) {
                    ...
                    case JResetAnswer.code:
                        handleEvent(new Event(Event.Type.RECEIVE_RSA, messageFactory.createResetRequest(request),
                                messageFactory.createResetAnswer(answer)));
                        break;
