...
public class RoSessionFactoryImpl
        implements IRoSessionFactory, ClientRoSessionListener, ServerRoSessionListener, StateChangeListener<AppSession>,
    ...
    public RoSessionFactoryImpl(SessionFactory sessionFactory, int defaultDirectDebitingFailureHandling,
    ...
    public AppSession getNewSession(String sessionId, Class<? extends AppSession> aClass, ApplicationId applicationId,
        ...
        try {
            ...
            if (aClass == ClientRoSession.class) {
                ...
                IClientRoSessionData sessionData = (IClientRoSessionData) this.sessionDataFactory
                        .getAppSessionData(ClientRoSession.class, sessionId);
                sessionData.setApplicationId(applicationId);
                clientSession = new ClientRoSessionImpl(sessionData, this.getMessageFactory(), sessionFactory,
                ...
                IServerRoSessionData sessionData = (IServerRoSessionData) this.sessionDataFactory
                        .getAppSessionData(ServerRoSession.class, sessionId);
                sessionData.setApplicationId(applicationId);
                ServerRoSessionImpl serverSession = new ServerRoSessionImpl(sessionData, this.getMessageFactory(),
                ...
                throw new IllegalArgumentException("Wrong session class: " + aClass + ". Supported[" + ClientRoSession.class
                        + "," + ServerRoSession.class + "]");
            }
        } catch (Exception e) {
    ...
    public AppSession getSession(String sessionId, Class<? extends AppSession> aClass) {
        ...
        try {
            if (aClass == ClientRoSession.class) {
                IClientRoSessionData sessionData = (IClientRoSessionData) this.sessionDataFactory
                        .getAppSessionData(ClientRoSession.class, sessionId);
                ClientRoSessionImpl clientSession = new ClientRoSessionImpl(sessionData, this.getMessageFactory(),
    ...
    public void stateChanged(AppSession source, Enum oldState, Enum newState) {
        logger.info("Diameter Ro SessionFactory :: stateChanged :: source[{}], oldState[{}], newState[{}]",
