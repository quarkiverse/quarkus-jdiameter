...
public class RfSessionFactoryImpl
        implements IRfSessionFactory, ServerRfSessionListener, ClientRfSessionListener, IClientRfActionContext,
    ...
    public AppSession getSession(String sessionId, Class<? extends AppSession> aClass) {
        ...
        try {
            if (aClass == ServerRfSession.class) {
                IServerRfSessionData sessionData = (IServerRfSessionData) this.sessionDataFactory
                        .getAppSessionData(ServerRfSession.class, sessionId);
                // FIXME: determine how to get boolean flag!
                ServerRfSessionImpl session = new ServerRfSessionImpl(sessionData, sessionFactory, getServerSessionListener(),
                ...
                IClientRfSessionData sessionData = (IClientRfSessionData) this.sessionDataFactory
                        .getAppSessionData(ClientRfSession.class, sessionId);
                ClientRfSessionImpl session = new ClientRfSessionImpl(sessionData, sessionFactory, getClientSessionListener(),
                ...
                throw new IllegalArgumentException("Wrong session class: " + aClass + ". Supported[" + ClientRfSession.class
                        + "," + ServerRfSession.class + "]");
            }
        } catch (Exception e) {
    ...
    public void stateChanged(AppSession source, Enum oldState, Enum newState) {
        logger.info("Diameter Rf SessionFactory :: stateChanged :: source[{}], oldState[{}], newState[{}]",
    ...
    public void doRfAccountingRequestEvent(ServerRfSession appSession, RfAccountingRequest acr)
        ...
        logger.info(
                "Diameter Base RfSessionFactory :: doAccRequestEvent :: appSession[" + appSession + "], Request[" + acr + "]");
    }
    ...
    public void doOtherEvent(AppSession appSession, AppRequestEvent request, AppAnswerEvent answer)
            throws InternalException, IllegalDiameterStateException, RouteException, OverloadException {
        logger.info("Diameter Base RfountingSessionFactory :: doOtherEvent :: appSession[" + appSession + "], Request["
