...
public class ServerAuthSessionImpl extends AppAuthSessionImpl
    ...
    public ServerAuthSessionImpl(IServerAuthSessionData sessionData, ISessionFactory sf, ServerAuthSessionListener lst,
        ...
        try {
            ...
            if (sessionData.getTsTimeout() > 0) {
                sessionData.setTsTimerId(
                        super.timerFacility.schedule(sessionData.getSessionId(), TIMER_NAME_TS, sessionData.getTsTimeout()));
            }
        } finally {
            sendAndStateLock.unlock();
        }
