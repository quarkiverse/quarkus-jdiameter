...
public class CxDxServerSessionImpl extends CxDxSession
    ...
    public CxDxServerSessionImpl(IServerCxDxSessionData sessionData, ICxDxMessageFactory fct, ISessionFactory sf,
     ...
     *
     * @see
     * org.jdiameter.api.cxdx.ServerCxDxSession#sendLocationInformationAnswer(org.jdiameter.api.cxdx.events.JLocationInfoAnswer)
     */
    @Override
     ...
     *
     * @see
     * org.jdiameter.api.cxdx.ServerCxDxSession#sendMultimediaAuthAnswer(org.jdiameter.api.cxdx.events.JMultimediaAuthAnswer)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.jdiameter.api.cxdx.ServerCxDxSession#sendServerAssignmentAnswer(org.jdiameter.api.cxdx.events.
     ...
     * (non-Javadoc)
     *
     * @see org.jdiameter.api.cxdx.ServerCxDxSession#sendUserAuthorizationAnswer(org.jdiameter.api.cxdx.events.
     ...
     * (non-Javadoc)
     *
     * @see org.jdiameter.api.cxdx.ServerCxDxSession#sendRegistrationTerminationRequest(org.jdiameter.api.cxdx.events.
                ...
                case MESSAGE_SENT_RECEIVED:
                    switch (eventType) {
                        ...
                        case RECEIVE_PPA:
                            try {
                                super.cancelMsgTimer();
                                listener.doPushProfileAnswer(this, (JPushProfileRequest) localEvent.getRequest(),
                        ...
                        case RECEIVE_RTA:
                            try {
                                super.cancelMsgTimer();
                                listener.doRegistrationTerminationAnswer(this,
                                        (JRegistrationTerminationRequest) localEvent.getRequest(),
            ...
            try {
                switch (request.getCommandCode()) {
                    case JUserAuthorizationRequest.code:
                        handleEvent(new Event(Event.Type.RECEIVE_UAR, messageFactory.createUserAuthorizationRequest(request),
                                null));
                        break;

                    case JServerAssignmentRequest.code:
                        handleEvent(
                                new Event(Event.Type.RECEIVE_SAR, messageFactory.createServerAssignmentRequest(request), null));
                        break;

                    case JMultimediaAuthRequest.code:
                        handleEvent(
                                new Event(Event.Type.RECEIVE_MAR, messageFactory.createMultimediaAuthRequest(request), null));
                        break;
            ...
            try {
                switch (answer.getCommandCode()) {
                    ...
                    case JPushProfileAnswer.code:
                        handleEvent(new Event(Event.Type.RECEIVE_PPA, messageFactory.createPushProfileRequest(request),
                                messageFactory.createPushProfileAnswer(answer)));
                        break;

                    case JRegistrationTerminationAnswer.code:
                        handleEvent(
                                new Event(Event.Type.RECEIVE_RTA, messageFactory.createRegistrationTerminationRequest(request),
