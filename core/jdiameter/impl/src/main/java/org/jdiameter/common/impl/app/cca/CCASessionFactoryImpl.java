...
public class CCASessionFactoryImpl
        implements ICCASessionFactory, ClientCCASessionListener, ServerCCASessionListener, StateChangeListener<AppSession>,
    ...
    public CCASessionFactoryImpl(SessionFactory sessionFactory, int defaultDirectDebitingFailureHandling,
    ...
    public AppSession getSession(String sessionId, Class<? extends AppSession> aClass) {
        ...
        try {
            if (aClass == ClientCCASession.class) {
                ...
                IClientCCASessionData data = (IClientCCASessionData) this.sessionDataFactory
                        .getAppSessionData(ClientCCASession.class, sessionId);
                ...
                IServerCCASessionData data = (IServerCCASessionData) this.sessionDataFactory
                        .getAppSessionData(ServerCCASession.class, sessionId);

                serverSession = new ServerCCASessionImpl(data, this.getMessageFactory(), sessionFactory,
    ...
    public void stateChanged(AppSession source, Enum oldState, Enum newState) {
        logger.info("Diameter CCA SessionFactory :: stateChanged :: source[{}], oldState[{}], newState[{}]",
