...
public class GqSessionFactoryImpl implements IAuthSessionFactory, IAuthMessageFactory, ServerAuthSessionListener,
    ...
    /**
     * @param clientSessionContext the clientSessionContext to set
     */
    @Override
    ...
    /**
     * @param serverSessionContext the serverSessionContext to set
     */
    @Override
    ...
    public AppSession getSession(String sessionId, Class<? extends AppSession> aClass) {
        ...
        try {
            if (aClass == GqServerSession.class) {
                IServerAuthSessionData sessionData = (IServerAuthSessionData) this.sessionDataFactory
                        .getAppSessionData(GqServerSession.class, sessionId);
                GqServerSessionImpl session = new GqServerSessionImpl(sessionData, sessionFactory, getServerSessionListener(),
                        getMessageFactory(),
                ...
                if (aClass == GqClientSession.class) {
                    IClientAuthSessionData sessionData = (IClientAuthSessionData) this.sessionDataFactory
                            .getAppSessionData(GqClientSession.class, sessionId);
                    GqClientSessionImpl session = new GqClientSessionImpl(sessionData, sessionFactory,
                            getClientSessionListener(), getMessageFactory(),
    ...
    public AppSession getNewSession(String sessionId, Class<? extends AppSession> aClass, ApplicationId applicationId,
        ...
        try {
            if (aClass == GqServerSession.class) {
                ...
                IServerAuthSessionData sessionData = (IServerAuthSessionData) this.sessionDataFactory
                        .getAppSessionData(ServerAuthSession.class, sessionId);
                ...
                if (aClass == GqClientSession.class) {
                    ...
                    IClientAuthSessionData sessionData = (IClientAuthSessionData) this.sessionDataFactory
                            .getAppSessionData(ClientAuthSession.class, sessionId);
                    sessionData.setApplicationId(applicationId);
                    GqClientSessionImpl session = new GqClientSessionImpl(sessionData, sessionFactory,
                            getClientSessionListener(), getMessageFactory(),
                            getStateListener(), getClientSessionContext(), isStateles());
    ...
    public void doAbortSessionAnswerEvent(ServerAuthSession appSession, AbortSessionAnswer asa)
            throws InternalException, IllegalDiameterStateException, RouteException, OverloadException {
        logger.info("Diameter Gq AuthorizationSessionFactory :: doAbortSessionAnswerEvent :: appSession[{}], ASA[{}]",
                appSession, asa);
    }
     ...
     *
     * @see org.jdiameter.api.auth.ServerAuthSessionListener#
     * doSessionTerminationRequestEvent(org.jdiameter.api.auth.ServerAuthSession,
    ...
    public void doSessionTerminationRequestEvent(ServerAuthSession appSession, SessionTermRequest str)
            throws InternalException, IllegalDiameterStateException, RouteException, OverloadException {
        logger.info("Diameter Gq AuthorizationSessionFactory :: doSessionTerminationRequestEvent :: appSession[{}], STR[{}]",
                appSession, str);
    }
     ...
     *
     * @see org.jdiameter.api.auth.ClientAuthSessionListener#
     * doSessionTerminationAnswerEvent(org.jdiameter.api.auth.ClientAuthSession,
    ...
    public void doSessionTerminationAnswerEvent(ClientAuthSession appSession, SessionTermAnswer sta)
            throws InternalException, IllegalDiameterStateException, RouteException, OverloadException {
        logger.info("Diameter Gq AuthorizationSessionFactory :: doSessionTerminationAnswerEvent :: appSession[{}], STA[{}]",
                appSession, sta);
    }
     ...
     * (non-Javadoc)
     *
     * @see org.jdiameter.api.auth.ServerAuthSessionListener#doAuthRequestEvent(org.jdiameter.api.auth.ServerAuthSession,
     * org.jdiameter.api.app.AppRequestEvent)
     */
    @Override
    public void doAuthRequestEvent(ServerAuthSession appSession, AppRequestEvent request)
            throws InternalException, IllegalDiameterStateException, RouteException, OverloadException {
        logger.info("Diameter Gq AuthorizationSessionFactory :: doAuthRequestEvent :: appSession[{}], Request[{}]", appSession,
                request);
    }
     ...
     *
     * @see org.jdiameter.api.auth.ClientAuthSessionListener#
     * doAuthAnswerEvent(org.jdiameter.api.auth.ClientAuthSession, org.jdiameter.api.app.AppRequestEvent,
    ...
    public void doReAuthRequestEvent(ClientAuthSession appSession, ReAuthRequest rar)
            throws InternalException, IllegalDiameterStateException, RouteException, OverloadException {
        logger.info("Diameter Gq AuthorizationSessionFactory :: doReAuthRequestEvent :: appSession[{}], RAR[{}]", appSession,
                rar);
    }
     ...
     *
     * @see org.jdiameter.api.auth.ServerAuthSessionListener#
     * doReAuthAnswerEvent(org.jdiameter.api.auth.ServerAuthSession, org.jdiameter.api.auth.events.ReAuthRequest,
    ...
    public void doReAuthAnswerEvent(ServerAuthSession appSession, ReAuthRequest rar, ReAuthAnswer raa)
        ...
        logger.info("Diameter Gq AuthorizationSessionFactory :: doReAuthAnswerEvent :: appSession[{}], RAR[{}], RAA[{}]",
                new Object[] { appSession, rar, raa });
    }
     ...
     *
     * @see org.jdiameter.api.auth.ServerAuthSessionListener#
     * doOtherEvent(org.jdiameter.api.app.AppSession, org.jdiameter.api.app.AppRequestEvent,
     * org.jdiameter.api.app.AppAnswerEvent)
     */
    @Override
    ...
    public void stateChanged(Enum oldState, Enum newState) {
        logger.info("Diameter Gq AuthorizationSessionFactory  :: stateChanged :: oldState[{}], newState[{}]", oldState,
                newState);
    }
    ...
    public void stateChanged(AppSession source, Enum oldState, Enum newState) {
        logger.info("Diameter Gq AuthorizationSessionFactory :: stateChanged :: source[{}], oldState[{}], newState[{}]",
     ...
     *
     * @see
     * org.jdiameter.common.api.app.auth.IClientAuthActionContext#accessTimeoutElapses(org.jdiameter.api.auth.ClientAuthSession)
     */
    @Override
     ...
     *
     * @see
     * org.jdiameter.common.api.app.auth.IClientAuthActionContext#disconnectUserOrDev(org.jdiameter.api.auth.ClientAuthSession,
     ...
     *
     * @see
     * org.jdiameter.common.api.app.auth.IServerAuthActionContext#accessTimeoutElapses(org.jdiameter.api.auth.ServerAuthSession)
     */
    @Override
