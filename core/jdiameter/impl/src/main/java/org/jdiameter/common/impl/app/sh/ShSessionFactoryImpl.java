...
public class ShSessionFactoryImpl
        implements IShSessionFactory, StateChangeListener<AppSession>, ClientShSessionListener, ServerShSessionListener,
        IShMessageFactory {
    ...
    public ShSessionFactoryImpl(SessionFactory sessionFactory) {
        ...
        this.sessionDataFactory = (IAppSessionDataFactory<IShSessionData>) this.sessionDataSource
