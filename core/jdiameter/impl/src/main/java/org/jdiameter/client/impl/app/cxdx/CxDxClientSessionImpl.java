        ...
        implements ClientCxDxSession, EventListener<Request, Answer>, NetworkReqListener
{
     ...
     * (non-Javadoc)
     *
     * @see org.jdiameter.api.cxdx.ClientCxDxSession#sendLocationInformationRequest(org.jdiameter.api.cxdx.events.
            ...
            try {
                switch (answer.getCommandCode()) {
                    case JUserAuthorizationAnswer.code:
                        handleEvent(
                                new Event(Event.Type.RECEIVE_UAA, null, messageFactory.createUserAuthorizationAnswer(answer)));
                        break;
