...
/**
 * Factory of Network Layer elements. This interface append to parent interface additional method for creating
 * INetWorkGuard guard instances. Additional parameters (Configuration, Parsers and etc) injection to instance over
 * constructor
 *
...
public interface ITransportLayerFactory extends org.jdiameter.client.api.io.ITransportLayerFactory {
     ...
     * @throws TransportException
     */
    INetworkGuard createNetworkGuard(InetAddress inetAddress, int port, INetworkConnectionListener listener)
            throws TransportException;
