...
public class S13ServerSessionImpl extends S13Session
        implements ServerS13Session, EventListener<Request, Answer>, NetworkReqListener {
    ...
    public S13ServerSessionImpl(IServerS13SessionData sessionData, IS13MessageFactory fct, ISessionFactory sf,
            ...
            try {
                switch (request.getCommandCode()) {
                    case JMEIdentityCheckRequest.code:
                        handleEvent(
                                new Event(Event.Type.RECEIVE_ECR, messageFactory.createMEIdentityCheckRequest(request), null));
                        break;
