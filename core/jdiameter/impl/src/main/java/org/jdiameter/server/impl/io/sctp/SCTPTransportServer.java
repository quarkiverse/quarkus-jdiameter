...
public class SCTPTransportServer
{
	 ...
	 * Default constructor
	 *
	 * @param parentConnectionConnection connection created this transport
	 */
	...
	public void startServer() throws NotInitializedException
	{
		...
		logger.debug("Successfuly initialized SCTP Server Host[{}:{}] Peer[{}:{}]",
					 new Object[]{
							 serverAssociation.getHostAddress(), serverAssociation.getHostPort(), serverAssociation.getPeerAddress(),
