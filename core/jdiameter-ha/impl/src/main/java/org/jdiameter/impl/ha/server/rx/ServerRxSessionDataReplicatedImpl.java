 ...
 package org.jdiameter.impl.ha.server.rx;
 ...
 public class ServerRxSessionDataReplicatedImpl extends AppSessionDataReplicatedImpl implements IServerRxSessionData
 {
     ...
     public ServerRxSessionDataReplicatedImpl(String sessionId, CachedSessionDatasource datasource)
     {
         super(sessionId, datasource);

         setAppSessionIface(ServerRxSession.class);
     }
     ...
     {
         return ServerRxSessionState.valueOf(getFieldValue(STATE, "IDLE"));
     }
