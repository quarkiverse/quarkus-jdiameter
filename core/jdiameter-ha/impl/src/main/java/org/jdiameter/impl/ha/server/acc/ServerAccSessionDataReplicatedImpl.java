 ...
 package org.jdiameter.impl.ha.server.acc;
 ...
 public class ServerAccSessionDataReplicatedImpl extends AppSessionDataReplicatedImpl implements IServerAccSessionData
 {
     ...
     public ServerAccSessionDataReplicatedImpl(String sessionId, CachedSessionDatasource datasource)
     {
         super(sessionId, datasource);

         setAppSessionIface(ServerAccSession.class);
     }
     ...
     {
         return ServerAccSessionState.valueOf(getFieldValue(STATE, "IDLE"));
     }
