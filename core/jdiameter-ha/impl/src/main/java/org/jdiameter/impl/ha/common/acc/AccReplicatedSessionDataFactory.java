 ...
 package org.jdiameter.impl.ha.common.acc;
 ...
 import org.jdiameter.impl.ha.client.acc.ClientAccSessionDataReplicatedImpl;
     ...
     public IAccSessionData getAppSessionData(Class<? extends AppSession> clazz, String sessionId)
     {
         if (clazz.equals(ClientAccSession.class)) {
             ClientAccSessionDataReplicatedImpl data =
                     new ClientAccSessionDataReplicatedImpl(sessionId, this.cachedSessionDataSource);
             return data;
         } else if (clazz.equals(ServerAccSession.class)) {
             ServerAccSessionDataReplicatedImpl data = new ServerAccSessionDataReplicatedImpl(sessionId, this.cachedSessionDataSource);
             return data;
         }
