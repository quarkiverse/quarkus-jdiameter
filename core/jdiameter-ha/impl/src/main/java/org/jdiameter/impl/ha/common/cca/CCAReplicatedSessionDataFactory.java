 ...
 package org.jdiameter.impl.ha.common.cca;
 ...
 import org.jdiameter.impl.ha.client.cca.ClientCCASessionDataReplicatedImpl;
     ...
     public ICCASessionData getAppSessionData(Class<? extends AppSession> clazz, String sessionId)
     {
         if (clazz.equals(ClientCCASession.class)) {
             ClientCCASessionDataReplicatedImpl data =
                     new ClientCCASessionDataReplicatedImpl(sessionId, cachedSessionDataSource);
             return data;
         } else if (clazz.equals(ServerCCASession.class)) {
             ServerCCASessionDataReplicatedImpl data = new ServerCCASessionDataReplicatedImpl(sessionId, cachedSessionDataSource);
             return data;
         }
