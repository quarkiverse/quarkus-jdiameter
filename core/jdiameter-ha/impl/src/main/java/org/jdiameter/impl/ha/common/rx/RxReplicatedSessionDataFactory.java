 ...
 package org.jdiameter.impl.ha.common.rx;
 ...
 import org.jdiameter.impl.ha.client.rx.ClientRxSessionDataReplicatedImpl;
 import org.jdiameter.impl.ha.data.CachedSessionDatasource;
 import org.jdiameter.impl.ha.server.rx.ServerRxSessionDataReplicatedImpl;
     ...
     public IRxSessionData getAppSessionData(Class<? extends AppSession> clazz, String sessionId)
     {
         if (clazz.equals(ClientRxSession.class)) {
             ClientRxSessionDataReplicatedImpl data =
                     new ClientRxSessionDataReplicatedImpl(sessionId, cachedSessionDataSource);
             return data;
         } else if (clazz.equals(ServerRxSession.class)) {
             ServerRxSessionDataReplicatedImpl data = new ServerRxSessionDataReplicatedImpl(sessionId, cachedSessionDataSource);
             return data;
         }
