 ...
 package org.jdiameter.impl.ha.common.gx;
 ...
 import org.jdiameter.impl.ha.client.gx.ClientGxSessionDataReplicatedImpl;
 import org.jdiameter.impl.ha.data.CachedSessionDatasource;
 import org.jdiameter.impl.ha.server.gx.ServerGxSessionDataReplicatedImpl;
 ...
 public class GxReplicatedSessionDataFactory implements IAppSessionDataFactory<IGxSessionData>
 {
     ...
     public GxReplicatedSessionDataFactory(CachedSessionDatasource replicatedSessionDataSource)
     { // Is this ok?
         super();
     ...
     public IGxSessionData getAppSessionData(Class<? extends AppSession> clazz, String sessionId)
     {
         if (clazz.equals(ClientGxSession.class)) {
             ClientGxSessionDataReplicatedImpl data =
                     new ClientGxSessionDataReplicatedImpl(sessionId, cachedSessionDataSource);
             return data;
         } else if (clazz.equals(ServerGxSession.class)) {
             ServerGxSessionDataReplicatedImpl data = new ServerGxSessionDataReplicatedImpl(sessionId, cachedSessionDataSource);
             return data;
         }
