 ...
 package org.jdiameter.impl.ha.client.cca;
 ...
 public class ClientCCASessionDataReplicatedImpl extends AppSessionDataReplicatedImpl implements IClientCCASessionData
 {
     ...
     public ClientCCASessionDataReplicatedImpl(String sessionId, CachedSessionDatasource datasource)
     {
         super(sessionId, datasource);

         setAppSessionIface(ClientCCASession.class);
     ...
     {
         return ClientCCASessionState.valueOf(getFieldValue(STATE, "IDLE"));
     }
     ...
     {
         byte[] data = getByteFieldValue(TXTIMER_REQUEST);
         if (data != null) {
             try {
