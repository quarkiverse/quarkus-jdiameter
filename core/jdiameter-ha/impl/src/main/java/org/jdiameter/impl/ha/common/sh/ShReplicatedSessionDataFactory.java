 ...
 package org.jdiameter.impl.ha.common.sh;
 ...
 import org.jdiameter.impl.ha.client.sh.ShClientSessionDataReplicatedImpl;
 import org.jdiameter.impl.ha.data.CachedSessionDatasource;
 import org.jdiameter.impl.ha.server.sh.ShServerSessionDataReplicatedImpl;
 ...
 public class ShReplicatedSessionDataFactory implements IAppSessionDataFactory<IShSessionData>
 {
     ...
     public IShSessionData getAppSessionData(Class<? extends AppSession> clazz, String sessionId)
     {
         if (clazz.equals(ClientShSession.class)) {
             ShClientSessionDataReplicatedImpl data = new ShClientSessionDataReplicatedImpl(sessionId, cachedSessionDataSource);
             return data;
         } else if (clazz.equals(ServerShSession.class)) {
             ShServerSessionDataReplicatedImpl data = new ShServerSessionDataReplicatedImpl(sessionId, cachedSessionDataSource);
             return data;
         }
