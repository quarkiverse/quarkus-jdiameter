 ...
 package org.jdiameter.impl.ha.client.cxdx;
 ...
 public class ClientCxDxSessionDataReplicatedImpl extends CxDxSessionDataReplicatedImpl implements IClientCxDxSessionData
 {
     ...
     public ClientCxDxSessionDataReplicatedImpl(String sessionId, CachedSessionDatasource datasource)
     {
         super(sessionId, datasource);

         setAppSessionIface(ClientCxDxSession.class);
