 ...
 package org.jdiameter.impl.ha.common.auth;
 ...
 import org.jdiameter.impl.ha.client.auth.ClientAuthSessionDataReplicatedImpl;
 import org.jdiameter.impl.ha.data.CachedSessionDatasource;
 import org.jdiameter.impl.ha.server.auth.ServerAuthSessionDataReplicatedImpl;
 ...
 public class AuthReplicatedSessionDataFactory implements IAppSessionDataFactory<IAuthSessionData>
 {
     ...
     public IAuthSessionData getAppSessionData(Class<? extends AppSession> clazz, String sessionId)
     {
         if (clazz.equals(ClientAuthSession.class)) {
             ClientAuthSessionDataReplicatedImpl data = new ClientAuthSessionDataReplicatedImpl(sessionId, cachedSessionDataSource);
             return data;
         } else if (clazz.equals(ServerAuthSession.class)) {
             ServerAuthSessionDataReplicatedImpl data = new ServerAuthSessionDataReplicatedImpl(sessionId, cachedSessionDataSource);
             return data;
         }
